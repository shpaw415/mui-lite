...
function Slider({
	...
	const styleForTrack: CSSProperties = {};
	...
	return (
		<span className={clsx(root.combined, _style.classNameFromSx)} style={_style.styleFromSx} ref={rootRef}>
