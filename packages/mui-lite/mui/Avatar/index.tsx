...
export default function Avatar({
	...
	return (
		<div className={clsx(root.combined, _style.classNameFromSx)} style={_style.styleFromSx} {...props}>
			{src && !fallback ? (
...
export function AvatarGroup({
	...
	return (
		<div
			className={clsx(Group.combined, style.classNameFromSx)} style={{ ...style.styleFromSx,
				...spaceOverRide,
			}}
			{...props}
		>
			{surplus > 0 && (
				<Avatar className="MUI_Avatar_surplus">
